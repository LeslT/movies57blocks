    ...
    <div className="border shadow-lg">
      ...
      >
        <div className="overflow-hidden">
          <img
            ...
            alt={`Imagen de ${movie.original_title}`}
      ...
      <div>
        <button
          ...
          className={
            isFavorite
              ? "bg-orange-400 hover:bg-orange-500 mt-5 w-full p-3 font-bold text-white text-lg uppercase"
              : "bg-green-400 hover:bg-green-500 mt-5 w-full p-3 font-bold text-white text-lg uppercase"
          }
